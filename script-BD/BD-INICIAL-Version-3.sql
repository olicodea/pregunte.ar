...
('¿Quienes son los tenistas con más títulos de Grand Slam en la historia del tenis masculino?', 2, 1, 1, 1),
('¿Quién ganó la Copa del Mundo de Fútbol en 2022?', 1, 1, 1, 2),
('¿Quién tiene el récord de más medallas de oro olímpicas en la historia de los Juegos Olímpicos?', 2, 1, NULL, 3),
('¿Cuál de los siguientes planetas del sistema solar es conocido como el planeta rojo?', 1, 2, NULL, 4),
('¿Cuál de las siguientes partículas subatómicas tiene una carga eléctrica negativa?', 3, 2, NULL, 5),
('¿Cuál de las siguientes enfermedades se caracteriza por la inflamación de las articulaciones?', 2, 2, NULL, 6),
('¿Cuál de los siguientes líderes no estuvo involucrado en la Segunda Guerra Mundial?', 2, 3, NULL, 7),
('¿Cuál de las siguientes civilizaciones fue conocida por construir las pirámides de Giza?', 2, 3, NULL, 8),
('¿Quién fue el primer presidente de Estados Unidos?', 1, 3, NULL, 9),
('¿Quién pintó la famosa obra "La última cena"?', 3, 4, NULL, 10),
('¿Cuál de los siguientes compositores es conocido por su obra "La Quinta Sinfonía"?', 2, 4, NULL, 11),
('¿Cuál de las siguientes esculturas famosas se encuentra en Río de Janeiro, Brasil?', 1, 4, NULL, 12),
('¿Cuál de los siguientes países no forma parte de la península ibérica?', 2, 5, NULL, 13),
('¿Cuál es el río más largo del mundo?', 3, 5, NULL, 14),
('¿Cuál de los siguientes países se encuentra en Europa y Asia?', 1, 5, NULL, 15),
('¿Cuál de las siguientes compañías es conocida por desarrollar el sistema operativo iOS?', 1, 6, NULL, 16),
('¿Qué siglas representan la tecnología inalámbrica utilizada para conectar dispositivos a corta distancia?', 3, 6, NULL, 17),
('¿Cuál de las siguientes redes sociales es conocida por compartir fotos y videos de corta duración?', 1, 6, NULL, 18),
('¿Quién interpretó el papel de Iron Man en el Universo Cinematográfico de Marvel?', 1, 7, NULL, 19),
('¿Cuál de las siguientes bandas de rock es conocida por su álbum "Stairway to Heaven"?', 2, 7, NULL, 20),
('¿Cuál de las siguientes películas ganó el Premio de la Academia a la Mejor Película en el año 2020?', 3, 7, NULL, 21),
('¿Qué lenguaje de programación se utiliza principalmente para desarrollar aplicaciones móviles en el sistema operativo Android?', 1, 8, NULL, 22),
('¿Cuál de los siguientes conceptos de programación se refiere a la reutilización de código mediante la creación de plantillas predefinidas?', 3, 8, NULL, 23),
('¿Cuál de las siguientes opciones es un sistema de control de versiones ampliamente utilizado en el desarrollo de software?', 2, 8, NULL, 24);
