...
--
-- Volcado de datos para la tabla `pregunta_respondida`
--
...
INSERT INTO `ranking` (`idRanking`, `puntaje`, `puesto`, `idUsuario`) VALUES
    (1, 100, 1, 1);
...
--
-- Estructura de tabla para la tabla `partida_home`
--
...
--
-- Volcado de datos para la tabla `partida_home`
--
...
-- Indices de la tabla `partida_home`
--
...
-- AUTO_INCREMENT de la tabla `partida_home`
--
ALTER TABLE `partida_home`
...
-- Filtros para la tabla `partida_home`
--
ALTER TABLE `partida_home`
